...
export declare function buildWsFatalInsight(connection: StableWSConnection, event: Record<string, unknown>): {
    ...
    user_details: import("stream-chat/src/types").OwnUserResponse<import("stream-chat/src/types").DefaultGenerics> | import("stream-chat/src/types").UserResponse<import("stream-chat/src/types").DefaultGenerics> | undefined;
    device: import("stream-chat/src/types").BaseDeviceFields | undefined;
