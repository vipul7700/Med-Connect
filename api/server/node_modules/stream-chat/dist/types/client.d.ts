...
export declare class StreamChat<StreamChatGenerics extends ExtendableGenerics = DefaultGenerics> {
     ...
     */
    connectUser: (user: OwnUserResponse<StreamChatGenerics> | UserResponse<StreamChatGenerics>, userTokenOrProvider: TokenOrProvider) => Promise<void | import("stream-chat/src/types").ConnectionOpen<StreamChatGenerics>>;
    /**
     ...
     * @return {ConnectAPIResponse<StreamChatGenerics>} Returns a promise that resolves when the connection is setup
     */
    setUser: (user: OwnUserResponse<StreamChatGenerics> | UserResponse<StreamChatGenerics>, userTokenOrProvider: TokenOrProvider) => Promise<void | import("stream-chat/src/types").ConnectionOpen<StreamChatGenerics>>;
     ...
     */
    openConnection: () => Promise<void | import("stream-chat/src/types").ConnectionOpen<StreamChatGenerics>>;
    /**
     ...
     */
    _setupConnection: () => Promise<void | import("stream-chat/src/types").ConnectionOpen<StreamChatGenerics>>;
    /**
    ...
    */
     ...
     */
    connectAnonymousUser: () => Promise<void | import("stream-chat/src/types").ConnectionOpen<StreamChatGenerics>>;
    /**
     * @deprecated Please use connectAnonymousUser. Its naming is more consistent with its functionality.
     */
    setAnonymousUser: () => Promise<void | import("stream-chat/src/types").ConnectionOpen<StreamChatGenerics>>;
    /**
     ...
     * @return {ConnectAPIResponse<StreamChatGenerics>} Returns a promise that resolves when the connection is setup
     */
    setGuestUser(user: UserResponse<StreamChatGenerics>): Promise<void | import("stream-chat/src/types").ConnectionOpen<StreamChatGenerics>>;
    /**
     ...
     * @private
     */
    connect(): Promise<void | import("stream-chat/src/types").ConnectionOpen<StreamChatGenerics>>;
    /**
    ...
    translateMessage(messageId: string, language: string): Promise<APIResponse & StreamChatGenerics["messageType"] & {
        id: string;
        attachments?: import("stream-chat/src/types").Attachment<StreamChatGenerics>[] | undefined;
        ...
        type: import("stream-chat/src/types").MessageLabel;
        ...
        moderation_details?: import("stream-chat/src/types").ModerationDetailsResponse | undefined;
        own_reactions?: ReactionResponse<StreamChatGenerics>[] | null | undefined;
        pin_expires?: string | null | undefined;
        pinned_at?: string | null | undefined;
        pinned_by?: UserResponse<StreamChatGenerics> | null | undefined;
        poll?: import("stream-chat/src/types").PollResponse<StreamChatGenerics> | undefined; /**
         * Creates a new WebSocket connection with the current user. Returns empty promise, if there is an active connection
         */
        reaction_counts?: {
            [key: string]: number;
        ...
        reaction_groups?: {
            [key: string]: import("stream-chat/src/types").ReactionGroupResponse;
        } | null | undefined;
        reaction_scores?: {
            [key: string]: number;
        } | null | undefined;
        ...
        quoted_message?: import("stream-chat/src/types").MessageResponseBase<StreamChatGenerics> | undefined;
    }>;
    /**
     ...
     */
    commitMessage(id: string): Promise<APIResponse & import("stream-chat/src/types").UR & {
        id: string;
        attachments?: import("stream-chat/src/types").Attachment<DefaultGenerics>[] | undefined;
        html?: string | undefined;
        mml?: string | undefined;
        parent_id?: string | undefined;
        pin_expires?: string | null | undefined;
        ...
        poll?: import("stream-chat/src/types").PollResponse<DefaultGenerics> | undefined; /**
         * Creates a new WebSocket connection with the current user. Returns empty promise, if there is an active connection
         */
        reaction_counts?: {
            [key: string]: number;
        ...
        quoted_message?: import("stream-chat/src/types").MessageResponseBase<DefaultGenerics> | undefined;
    }>;
    /**
     * Creates a poll
