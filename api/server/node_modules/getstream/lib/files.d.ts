...
import { StreamClient } from 'getstream/src/client';
export declare class StreamFileStore {
     ...
     */
    upload(uri: string | File | Buffer | NodeJS.ReadStream, name?: string, contentType?: string, onUploadProgress?: (progressEvent: typeof AxiosProgressEvent) => void): Promise<import("getstream/src/client").FileUploadAPIResponse>;
    /**
     * delete an uploaded file
     * @link https://getstream.io/activity-feeds/docs/node/files_introduction/?language=js#delete
     * @param {string} uri
     */
    delete(uri: string): Promise<import("getstream/src/client").APIResponse>;
}
