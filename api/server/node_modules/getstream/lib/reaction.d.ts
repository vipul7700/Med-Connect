import { StreamClient, APIResponse, UR, DefaultGenerics } from 'getstream/src/client';
import { StreamFeed } from 'getstream/src/feed';
import { EnrichedUser } from 'getstream/src/user';
...
export declare class StreamReaction<StreamFeedGenerics extends DefaultGenerics = DefaultGenerics> {
     ...
     */
    delete(id: string, soft?: boolean): Promise<APIResponse>;
    /**
