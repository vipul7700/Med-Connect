...
export declare class Channel<StreamChatGenerics extends ExtendableGenerics = DefaultGenerics> {
     ...
     */
    getConfig(): import("stream-chat/src/types").ChannelConfigWithInfo<StreamChatGenerics> | undefined;
    /**
    ...
    sendFile(uri: string | NodeJS.ReadableStream | Buffer | File, name?: string, contentType?: string, user?: UserResponse<StreamChatGenerics>): Promise<import("stream-chat/src/types").SendFileAPIResponse>;
    sendImage(uri: string | NodeJS.ReadableStream | File, name?: string, contentType?: string, user?: UserResponse<StreamChatGenerics>): Promise<import("stream-chat/src/types").SendFileAPIResponse>;
     ...
     */
    vote(messageId: string, pollId: string, vote: PollVoteData): Promise<APIResponse & import("stream-chat/src/types").CastVoteAPIResponse<DefaultGenerics>>;
    removeVote(messageId: string, pollId: string, voteId: string): Promise<APIResponse & {
        vote: import("stream-chat/src/types").PollVote<DefaultGenerics>;
    }>;
    /**
    ...
    _initializeState(state: ChannelAPIResponse<StreamChatGenerics>, messageSetToAddToIfDoesNotExist?: MessageSetType): {
        messageSet: import("stream-chat/src/types").MessageSet<DefaultGenerics>;
    };
