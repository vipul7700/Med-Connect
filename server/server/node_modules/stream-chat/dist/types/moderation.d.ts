...
export declare class Moderation<StreamChatGenerics extends ExtendableGenerics = DefaultGenerics> {
    ...
    muteUser(targetID: string, options?: ModerationMuteOptions): Promise<APIResponse & {
        mute?: import("stream-chat/src/types").MuteResponse<StreamChatGenerics> | undefined;
        mutes?: import("stream-chat/src/types").Mute<StreamChatGenerics>[] | undefined;
        own_user?: import("stream-chat/src/types").OwnUserResponse<StreamChatGenerics> | undefined;
    }>;
    /**
     * Unmute a user
